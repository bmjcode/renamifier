...
; ghostxps-9.53.3-win64.zip                 (for the 64-bit version)
; ghostxps-9.53.3-win32.zip                 (for the 32-bit version)
;
; Usage:
...
!if ${PLATFORM} == "win64"
  ...
  !define GXPS_DIR "ghostxps-9.53.3-win64"
  InstallDir "$PROGRAMFILES64\Renamifier"

!else if ${PLATFORM} == "win32"
  !define MINGW_DIR "C:\msys64\mingw32"
  !define GXPS_DIR "ghostxps-9.53.3-win32"
...
Section "Renamifier"
  ...
  File "${MINGW_DIR}\bin\libicudt68.dll"
  File "${MINGW_DIR}\bin\libicuin68.dll"
  File "${MINGW_DIR}\bin\libicuuc68.dll"
  ...
  File "${MINGW_DIR}\bin\libpoppler-105.dll"
